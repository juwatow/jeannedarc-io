const userData = {
    ...
    about: {
      ...
      description: [
        ...
        ` Phase II | 2017-2022: This phase was about increasing the scope of ownership, delivery, and impact. Started by leading the first product team where the EPD triad partnership operated in the way described by Marty Cagan (PM: viable & valuable, Design: Usable, ENG: Feasible), experimenting with new ways of delivering a feature which resulted in releasing ahead of time and the team became an inspiration to other teams in the company. This phase was marked by developing leadership skills, guiding people through coaching, mentoring and sponsorship, implementing strategies to cope with industry challenges like hiring, compensation, onboarding, retaining and attrition.`,
        ` Phase III | 2022-Now - Engineering Leader: From my journey so far I have come to realize that any saas company will go through some transitions. While these transitions are inevitable, I am challenging myself to make them as smooth as possible for people and the organization by guiding them in putting quickly in place the adequate processes, habits and mindset for each step of the transition.`
      ],
    ...
    resumeUrl:
      "https://jeannedarc.io/jeanne-resume.pdf",
    socialLinks: {
